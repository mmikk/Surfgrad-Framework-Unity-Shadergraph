# Workflow: How to run a Play Mode test as standalone
...
![Run PlayMode test as standalone](./images/playmode-run-standalone.png)
...
![Results of PlayMode standalone test run](./images/playmode-results-standalone.png)
